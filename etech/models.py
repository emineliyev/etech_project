...
class About(models.Model):
    image = models.ImageField(blank=True, upload_to='image/about/%Y/%m/%d/', verbose_name='Şəkil', help_text='Şəkil ölçüsü: 545X470')
    title = models.CharField(blank=True, max_length=60, verbose_name='Haqqımda başlıq')
    text = models.TextField(blank=True, verbose_name='Haqqımda mətn')
    about_quote_title_1 = models.TextField(blank=True, verbose_name='Haqqımda sitat 1 başlıq')
    about_quote_1 = models.TextField(blank=True, verbose_name='Haqqımda sitat 1')
    about_quote_title_2 = models.TextField(blank=True, verbose_name='Haqqımda sitat 2 başlıq')
    about_quote_2 = models.TextField(blank=True, verbose_name='Haqqımda sitat 2')
